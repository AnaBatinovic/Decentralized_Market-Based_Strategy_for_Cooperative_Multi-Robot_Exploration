...
The weight matrix \boldsymbol{W} \mathbb{($N\times M$)} is formed for $N$ mobile robots and $M$ received frontier points: 
\begin{equation}
...
\bibitem{market-economy} R. Zlot, A.T. Stenz, M.B. Dias, and S. Thayer, Multi-robot exploration controlled by a market economy, in Proc. of the IEEE Int. Conf. on Robotics & Automation (ICRA), Washington, DC, USA, 2002.
...
\bibitem{Julia} M. Julia, A. Gil, and O. Reinoso, A comparison of path planning strategies for autonomous exploration and mapping of unknown environments, Autonomous Robots, vol. 33, no. 4, pp. 427–444, 2012. [Online]. Available: http://dx.doi.org/10.1007/s10514-012-9298-8

\bibitem{indoor} C. Stachniss, O. M. Mozos, and W. Burgard, Efficient exploration of
